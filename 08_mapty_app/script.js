...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(position => this._loadMap(position), function(error) {
          console.log(error);
        }
      );
    }
  ...
  _hideForm() {
    inputDuration.value = inputDistance.value = inputCadence.value = inputType.value = '';
